...
boat = Boat.create( name: 'Titanic',
             description: 'This elven noble\'s yacht has a bulky hull with lateen rigged canvas sails. The ship\'s captain is a female elf lady named Ainid, and it is crewed by an entourage of sailors.',
...
boat = Boat.create( name: 'The Peaceful Destiny',
             description: 'This explorer\'s ship has a bulky hull with three rows of long oars worked by ogre slaves. The ship\'s captain is a female wizard named Wulfwe. The ship\'s main hold contains a strange chimera.',
             location: 'Genslerstraße 82, Berlin',
             price_per_night: rand(50..500),
             user_id: user.id,
...
boat = Boat.create( name: 'The Fortress',
             description: 'This dwarven warship has a battle-scarred hull with a tall aftcastle. The ship\'s captain is a male dwarf named Mahor, and it is crewed by grim dwarven axemen. The ship is armed with a naval ram and a ballista.',
...
boat = Boat.create( name: 'The Silver Cutter',
             description:'This noble\'s yacht has a stout hull with a golden aftcastle, and is held aloft by a pair of magical giant feathered wings. The ship\'s captain is a male aristocrat named Edmugh Sparry, and it is crewed by an entourage of sailors.',
